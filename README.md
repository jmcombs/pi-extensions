...
| [`@jmcombs/pi-steward`](./packages/steward) | [![npm](https://img.shields.io/npm/v/@jmcombs/pi-steward.svg)](https://www.npmjs.com/package/@jmcombs/pi-steward) | Steward — the llama.cpp control panel for Pi. A local browser dashboard for service control, resident models, host health, and streamed logs. |
