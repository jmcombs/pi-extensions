...
| `prompt-enhancer` | —                                         | `prompt_enhance`, `prompt_enhance_model`, `prompt_enhance_revert`    | `session_start`, `session_shutdown`, `model_select`, `input`   | shortcuts `ctrl+shift+e`, `ctrl+shift+z`           |
