...
## [2.2.1](https://github.com/jmcombs/pi-extensions/compare/1password/v2.2.0...1password/v2.2.1) (2026-09-08)


### Bug Fixes

* **1password:** collect importer env-var literals in plugin extractor ([#242](https://github.com/jmcombs/pi-extensions/issues/242)) ([edbb99f](https://github.com/jmcombs/pi-extensions/commit/edbb99fedfa97ff0ac88829cfca6dbed9647e8d4))

## [2.2.0](https://github.com/jmcombs/pi-extensions/compare/1password/v2.1.0...1password/v2.2.0) (2026-08-24)


### Features

* **1password:** update curated shell plugins list from upstream source ([#222](https://github.com/jmcombs/pi-extensions/issues/222)) ([96d4869](https://github.com/jmcombs/pi-extensions/commit/96d4869e68c96fed13afc397e9dd21dbb3087243))
